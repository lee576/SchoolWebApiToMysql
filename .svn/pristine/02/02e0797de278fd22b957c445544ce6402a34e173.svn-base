        ...
        <div class="page-content">
            <div class="gray-box-border clearfix">
                    ...
                    <div class="yin-yo1 fl">
                        <div class="ymy-on1">{{ detailArr.ARID }}</div>
                        <div class="ymy-on2">{{ detailArr.name }}</div>
                    </div>
                ...
                <div class="table-box">
                    <template>
                        ...
                        <el-table :data="configTable.tableArr" stripe style="width: 100%">
                            <el-table-column v-if="isActive" :show-overflow-tooltip='true'  prop="out_order_no" label="订单编号" >
                            </el-table-column>
                            ...
                            <el-table-column  v-if="isActive" :show-overflow-tooltip='true' prop="pay_time" label="缴费时间">
                            </el-table-column>
