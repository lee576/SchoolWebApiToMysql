<template>
    <div class="home">
        <div class="nav-lead clearfix">
            <div class="fl nav-lead-word"><a href="#">成绩单管理</a></div>
            ...
            <div class="nav-tab-box">
                <div class="nav-tab1 clearfix">
                    <div class="fl on-part-search1">
                        <div class="fl left-word-on1" style="width:80px">科目名称</div>
                        <div class="fl form-timerange">
                            <div class="fl form-timerange">
                                <el-select placeholder="请选择科目" style="width:220px" v-model="subjectStr" @change="subjectChoose">
                                    <el-option v-for="item in subjectArr" :label="item" :value="item.id" :key="item.id"></el-option>
                                </el-select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="fr on-part-search1" style="margin-right: 0">
        ...
        <el-dialog title="批量导入" :visible.sync="dialogVisible" width="600px" top="20vh">
            <div class="gray-import">
                ...
                <div class="improt-word3">下载模板：<span @click="downloadTemplate($event)"  class="tb-edit">应缴费数据导入示例表</span></div>
            </div>
